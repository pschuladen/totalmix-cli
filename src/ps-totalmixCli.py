...
setParser.add_argument('-f', '--fast', action='store_true', help='"fast-mode":set values fast using the prefetchted data. Might not set correctly if parameters did change since fetch. NOT IMPLEMENTED YET')
